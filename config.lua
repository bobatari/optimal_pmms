...
-- Prefix for commands
Config.commandPrefix = "optimal"

-- Separator between prefix and command name
Config.commandSeparator = "_"

-- Enables selecting a media player entity directly with ox_target.
Config.enableOxTargetSelection = true

-- Interaction distance for the ox_target media player option.
Config.oxTargetSelectionDistance = 3.0
...
Config.allowedUrls = {
	...
	"^https?://stream-1-1-ip4.loadshare.org/.*$"
}
